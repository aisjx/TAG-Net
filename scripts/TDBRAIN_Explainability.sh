...
MODEL_ID_CHANRES=TDBRAIN-AblChanRes
...
python \
  ...
  --nodedim ${NODEDIM} \
  --augmentations ${AUGS} \
  --output_dir ./visualizations/TDBRAIN_view_contribution \
  --output_name TDBRAIN_TEST_dual_view_decision_contribution \
  --gpu ${GPU_ID}
...
python \
  ...
  --nodedim ${NODEDIM} \
  --augmentations ${AUGS} \
  --output_dir ./visualizations/TDBRAIN_resolution_interaction \
  --output_name TDBRAIN_TEST_resolution_interaction_full_vs_noChanRes \
  --gpu ${GPU_ID}
